...
@Component({
    ...
    styleUrls: ['./dotdataanalyticstree.component.scss'],
    templateUrl: './dotdataanalyticstree.component.html'
})
export class DotdataanalyticstreeComponent implements OnInit {
    version = 2;
